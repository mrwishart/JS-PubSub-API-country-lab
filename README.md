# XMLHTTPRequest Lab/Working with JSONs

Week 7, Day 3 afternoon lab at Codeclan. Further work with PubSub, integrating use of XMLHTTPRequest to connect with external servers
